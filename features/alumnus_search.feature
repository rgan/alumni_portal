Feature: Search
  Scenario: Should be able to search by first name
    ...
    | first_name | last_name| email | ug_college | pg_college |specialty|
    | Sam  | Bah   | foo@foo.com    |Rutgers  | Penn State | Internal medicine |
    ...
    Given the following alumni exist in the system:
    | first_name | last_name| email | ug_college | pg_college |specialty| city |  country |
    | Sam  | Bah | foo@foo.com | Rutgers | Penn State | Internal medicine | Brunswick |  USA |
